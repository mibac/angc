...
aNGCApp: markGps.o C2UTM.o CExitBtn.o CHoleButton.o CHolesPopup.o CLatLng.o CMarkBtn.o Course.o CWriteAllBtn.o CWriteMarkBtn.o gps.o HoleView.o
	g++ -o aNGCApp markGps.o C2UTM.o CExitBtn.o CHoleButton.o CHolesPopup.o CLatLng.o CMarkBtn.o Course.o CWriteAllBtn.o CWriteMarkBtn.o gps.o HoleView.o  $(LDFLAGS)

markGps.o: markGps.cpp C2UTM.cpp CExitBtn.cpp CHoleButton.cpp CHolesPopup.cpp CLatLng.cpp CMarkBtn.cpp Course.cpp CWriteAllBtn.cpp CWriteMarkBtn.cpp gps.cpp HoleView.cpp
	g++ -c $<  $(CXXFLAGS)

C2UTM.o: C2UTM.cpp C2UTM.hpp
	g++ -c $< $(CXXFLAGS)
...
HoleView.o: HoleView.cpp HoleView.hpp Course.cpp 
	g++ -c $<  $(CXXFLAGS)
