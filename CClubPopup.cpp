...
CClubPopup::CClubPopup(int X, int Y, int W, int H, const char *L)
  ...
  int col = colstart;
  int row = 2;
  b = new Fl_Button(col, row, bsize, bsize, "Dr");
  b->callback(Button_CB, (void *)this);
  setBtnAttributes(b);
  col += b->w() + kDeltaX;
  b = new Fl_Button(col, row, bsize, bsize, "3w");
  b->callback(Button_CB, (void *)this);
  setBtnAttributes(b);
  col += b->w() + kDeltaX;
  b = new Fl_Button(col, row, bsize, bsize, "5w");
  b->callback(Button_CB, (void *)this);
  setBtnAttributes(b);
  col = colstart;
  row += b->h();
  ...
  setBtnAttributes(b);
  b = new Fl_Button(col, row, bsize, bsize, "7w");
  b->callback(Button_CB, (void *)this);
  setBtnAttributes(b);
  col += b->w() + kDeltaX;
